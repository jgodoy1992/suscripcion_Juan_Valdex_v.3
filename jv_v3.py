            ...
            if opcion==1:
                ...
                while controlador:
                    ...
                    if 4000000<=rut<=99999999:
                        nombre=input('Nombre y apellidos_')
                        datos.append(nombre)
                                ...
                                if tipo=='PREMIUM' or tipo=='GOLD' or tipo=='SILVER':
                                    ...
                                    for char in correo:
                                        if char in string.punctuation:
                                            cont+=1
                                    if cont>=1:
                                        datos.append(f'{correo}@{dominio}')
                                        datos.append('suscrito')
                                        usuario[rut]=datos
                ...
                if registro=='registrado':
                    ...
                    if ops=='si':
                        ...
                        usuario[rut].append(fecha)
                        
                    else:
                        #suscripcion='no suscrito'
                        fecha=input('Ingrese la fecha (Año/mes/día)_')
                        for i,e in enumerate(usuario[rut]):
                            if e =='suscrito':
                                usuario[rut][i]='no suscrito'
                        usuario[rut].append(fecha)
                else:
                ...
                for usuario in usuarios:
                    if rut in usuario:
                        print(f'Informacion sobre el usuario rut: {rut}')
                        for i,e in enumerate(usuario[rut]):
                            print(f'{i+1}. {e}')
